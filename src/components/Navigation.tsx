...
import { LoginContext } from "./Layout"; // Assuming your context is exported as LoginContext
  ...
  return (
    <nav>
      <div className="flex">
        ...
        {!loginCredentials.jwtToken && <Link to="/login">
          <button className="m-4 px-4 w-auto h-10 rounded-md bg-blue-700 text-white font-bold text-lg">
            Login
          </button>
        </Link>}
        ...
        {loginCredentials.jwtToken && <button
